...
public class LauncherIconController {
    ...
    public enum LauncherIcon {
        ...
        CUSTOM1("CustomIcon1", R.color.ic_background, R.drawable.ic_foreground, R.string.AppIconDefault, false, true, 1),
        CUSTOM2("CustomIcon2", R.color.ic_background, R.drawable.ic_foreground, R.string.AppIconDefault, false, true, 2),
        CUSTOM3("CustomIcon3", R.color.ic_background, R.drawable.ic_foreground, R.string.AppIconDefault, false, true, 3);
        ...
        public final boolean isCustomSlot;
        public final int customSlotIndex;
        ...
        public Bitmap getCustomBitmap() {
            if (!isCustomSlot) return null;
            return CustomIconManager.getInstance().loadCustomIcon(customSlotIndex);
        }

        public boolean hasCustomBitmap() {
            if (!isCustomSlot) return false;
            return CustomIconManager.getInstance().hasCustomIcon(customSlotIndex);
        }
        ...
        LauncherIcon(String key, int background, int foreground, int title, boolean hidden) {
            ...
            this.customSlotIndex = 0;
        }

        LauncherIcon(String key, int background, int foreground, int title, boolean hidden, boolean isCustomSlot, int customSlotIndex) {
            this.key = key;
            this.background = background;
            this.foreground = foreground;
            this.title = title;
            this.premium = false;
            this.hidden = hidden;
            this.isCustomSlot = isCustomSlot;
            this.customSlotIndex = customSlotIndex;
        }
    }
}
