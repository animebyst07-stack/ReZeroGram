...
public class ApplicationLoader extends Application {
    ...
    public void onCreate() {
        ...
        GroqManager.getInstance().init(applicationContext);
        AccountNotificationManager.getInstance().init(applicationContext);
        CustomIconManager.getInstance().init(applicationContext);
